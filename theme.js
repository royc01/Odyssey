...
function setItem(key, value) {
    ...
    写入文件("/data/snippets/Odyssey.config.json", JSON.stringify(window.theme.config, undefined, 4));
}
...
获取文件("/data/snippets/Odyssey.config.json", (v) => {
    ...
    if (v == null) {
        ...
        写入文件("/data/snippets/Odyssey.config.json", JSON.stringify(window.theme.config, undefined, 4), (a) => { funs() });
    } else {
